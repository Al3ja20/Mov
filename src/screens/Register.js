            ...
            <FormControl isRequired mt="4">
              ...
              >
                ...
                <FormControl isRequired mt="4">
                  ...
                  <Slider defaultValue={age} onChange={v => {
                    setAge(Math.floor(v));
                  }}>
                    <Slider.Track>
                      <Slider.FilledTrack />
                ...
                <FormControl>
                  ...
                  <TextArea h={20} placeholder="Escribe una breve descripcion sobre ti"></TextArea>
                </FormControl>

                <FormControl>
                <HStack alignItems={"center"} space={4}>
                  <FormControl.Label>Recibir notificaciones</FormControl.Label>
                  <Switch offTrackColor="indigo.100" onTrackColor="indigo.200" onThumbColor="indigo.500" 
